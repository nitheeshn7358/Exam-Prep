  ...
  useEffect(() => {
    ...
    api.get(url)
      .then((res) => {
        ...
        setLoading(false)
        startSession(null, res.data.subject_name, 'exam', res.data.questions.length, parseInt(subjectId))
      })
      .catch((err) => {
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950">
      ...
      <div className="sticky top-0 z-10 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 px-6 py-3 flex items-center justify-between shadow-sm">
        ...
        <div className="flex items-center gap-6">
          <span className="text-sm text-gray-400 hidden sm:block">{subjectName}</span>
      ...
      <div className="max-w-3xl mx-auto px-6 py-8 space-y-5">
        ...
        <div className="mb-2">
          <h1 className="text-xl font-bold text-gray-800 dark:text-gray-100">Mock Exam — {subjectName}</h1>
